  ...
  render: function() {
    ...
    if (post.isReply) {
      var conversationLink = (
        React.createElement("small", null, React.createElement("em", null, React.createElement("a", {href: "#/conversation/"+post.replyUser+"/"+post.replyId}, React.createElement(Glyphicon, {glyph: "comment"}))))
      );
    } else {
