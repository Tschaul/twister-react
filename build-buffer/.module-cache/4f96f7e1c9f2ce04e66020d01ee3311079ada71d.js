...
module.exports = Home = React.createClass({displayName: "Home",
  ...
  handeSettingsUpdate: function (e) {
    e.preventDefault();
    console.log($(this.getDOMNode()).find(".settings-pollInterval").val())
  ...
  render: function() {
    return (
        ...
        React.createElement(Panel, {header: "Settings"}, 
            React.createElement(Input, {type: "text", label: "pollInterval", placeholder: "pollInterval", labelClassName: "col-xs-2", wrapperClassName: "col-xs-10", className: "settings-pollInterval"}), 
