...
module.exports = Home = React.createClass({displayName: "Home",
  ...
  handeSettingsUpdate: function (e) {
    e.preventDefault();
    console.log(React.findDOMNode(this.refs.pollInterval).value)
  ...
  render: function() {
    return (
        ...
        React.createElement(Panel, {header: "Settings"}, 
            React.createElement(Input, {type: "text", ref: "pollInterval", label: "pollInterval", placeholder: "pollInterval"}), 
