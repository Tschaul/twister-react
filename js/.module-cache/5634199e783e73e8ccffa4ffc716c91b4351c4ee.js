...
module.exports = Timeline = React.createClass({displayName: "Timeline",
  ...
  componentDidMount: function() {
    ...
    } else {console.lgo("active account is null")}
  ...
  render: function() {
      return (
          React.createElement(Postboard, {data: this.state.data, header: 
            React.createElement("span", null, 'Timeline of '+this.props.activeAccount),
            React.createElement(Button, {className: "pull-right fullytight_all", bsStyle: "link"}, React.createElement(Glyphicon, {glyph: "pencil"}))
          })
        );
  }
});