...
module.exports = Post = React.createClass({displayName: "Post",
    ...
    render: function() {
        ...
        return (
          ...
          post.isRetwist && 
              React.createElement(Col, {xs: 12}, React.createElement("span", {class: "glyphicon glyphicon-repeat", "aria-hidden": "true"}), React.createElement("small", null, "retwisted by ", post.retwistingUser)), 
