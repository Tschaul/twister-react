      ...
      React.createElement(ListGroup, {fill: true}, 
        ...
        React.createElement("div", {className: "container fullytight"}, 
          React.createElement(ButtonGroup, {justified: true}, 
            React.createElement(Button, {href: routeprefix+"timeline", bsStyle: subroute=="timeline" ? "active" : ""}, React.createElement(Glyphicon, {glyph: "list"})), 
            React.createElement(Button, {href: routeprefix+"following", bsStyle: subroute=="following" ? "active" : ""}, React.createElement(Glyphicon, {glyph: "eye-open"})), 
