...
module.exports = Post = React.createClass({displayName: "Post",
    ...
    render: function() {
        ...
        return (
          ...
          post.isRetwist && 
              React.createElement(Col, {xs: 12}, React.createElement("small", null, React.createElement("span", {className: "glyphicon glyphicon-repeat", "aria-hidden": "true"}), " retwisted by ", post.retwistingUser)), 
