  ...
  render: function() {
    ...
    switch (this.context.router.getCurrentParams().subroute) {
        ...
        case "mentions":
          ...
          var subcontent = (
              React.createElement(Mentions, {username: this.state.username, pollInterval: this.props.pollInterval})
            );
          break;
        default:
    ...
    return (
      React.createElement(ListGroup, {fill: true}, 
        ...
        React.createElement(ListGroupItem, {className: "fullytight"}, 
          React.createElement(ButtonGroup, {justified: true}, 
            React.createElement(Button, {href: routeprefix+"timeline", bsStyle: subroute=="timeline" ? "active" : "default"}, React.createElement(Glyphicon, {glyph: "list"})), 
            React.createElement(Button, {href: routeprefix+"followings", bsStyle: subroute=="followings" ? "active" : "default"}, React.createElement(Glyphicon, {glyph: "eye-open"})), 
            React.createElement(Button, {href: routeprefix+"mentions", bsStyle: subroute=="mentions" ? "active" : "default"}, React.createElement(Glyphicon, {glyph: "comment"}))
          )
        ), 
        subcontent
      )
