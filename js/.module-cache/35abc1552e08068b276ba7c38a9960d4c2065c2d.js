    ...
    return (
      React.createElement("div", {className: "container"}, 
        React.createElement(ButtonGroup, null, 
          ...
          React.createElement(OverlayTrigger, {trigger: "click", placement: "right", overlay: 
              React.createElement(Popover, {title: "Popover bottom"}, userbuttons)
            }, 
            React.createElement(Button, {bsStyle: "default"}, "Switch User")
          )
        ), 
...
var routes = (
  React.createElement(Route, {handler: App, path: "/"}, 
    React.createElement(DefaultRoute, {name: "timeline", path: "timeline", handler: Timeline}), 
