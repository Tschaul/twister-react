...
module.exports = Post = React.createClass({displayName: "Post",
    ...
    render: function() {
        ...
        return (
          ...
          post.isRetwist && 
              React.createElement(Col, {xs: 11}, React.createElement("small", null, React.createElement("span", {className: "glyphicon glyphicon-repeat", "aria-hidden": "true"}), " ", React.createElement("em", null, "retwisted by ", this.state.retwistingUser))), 
