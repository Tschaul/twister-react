      ...
      React.createElement(ListGroup, {fill: true}, 
        ...
        React.createElement(ListGroupItem, {className: "fullytight_all"}, 
          React.createElement(ButtonGroup, {justified: true}, 
            React.createElement(Button, {href: routeprefix+"timeline", bsStyle: subroute=="timeline" ? "tabs" : "default"}, React.createElement(Glyphicon, {glyph: "list"})), 
            React.createElement(Button, {href: routeprefix+"followings", bsStyle: subroute=="followings" ? "tabs" : "default"}, React.createElement(Glyphicon, {glyph: "eye-open"})), 
            React.createElement(Button, {href: routeprefix+"mentions", bsStyle: subroute=="mentions" ? "tabs" : "default"}, React.createElement(Glyphicon, {glyph: "comment"}))
          )
        ), 
        subcontent
      )
