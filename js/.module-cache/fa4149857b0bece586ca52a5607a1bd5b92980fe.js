...
App = React.createClass({displayName: "App",
  ...
  getHandlerKey: function () {
    ...
    if ( router.getCurrentRoutes()[childDepth] ) {
      ...
      if (key=="home" || key=="accountProfile" || key=="accountProfileMore") {key=key+"/"+this.state.activeAccount;}
        ...
        React.createElement(Row, null, 
          React.createElement(Col, {xs: 12, sm: 10, smOffset: 1, md: 8, mdOffset: 2, lg: 6, lgOffset: 3}, 
            React.createElement(ButtonGroup, {justified: true}, 
              ...
              React.createElement(Button, {
                href: "#/profile", 
                bsStyle: firstroute=="accountProfile" ? 'primary' : 'default'
...
var routes = (
  React.createElement(Route, {handler: App, path: "/"}, 
    React.createElement(Route, {name: "accountProfile", path: "/profile", handler: Profile}, 
      React.createElement(Route, {name: "profile-timeline", path: "/profile/active-user/timeline", handler: Timeline}), 
      React.createElement(Route, {name: "profile-followings", path: "/profile/active-user/followings", handler: Followings}), 
      React.createElement(Route, {name: "profile-mentions", path: "/profile/active-user/mentions", handler: Mentions})
    ), 
    React.createElement(Route, {name: "profile", path: "/profile/:username", handler: Profile}, 
      React.createElement(Route, {name: "profile-timeline", path: "/profile/:username/timeline", handler: Timeline}), 
      React.createElement(Route, {name: "profile-followings", path: "/profile/:username/followings", handler: Followings}), 
      React.createElement(Route, {name: "profile-mentions", path: "/profile/:username/mentions", handler: Mentions})
    ), 
