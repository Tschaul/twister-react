...
module.exports = Home = React.createClass({displayName: "Home",
  ...
  updatePosts: function(outdatedLimit) {
    ...
    var thisUsername = this.props.params.username;

    var count = 0;
    
    Twister.getUser(this.props.params.username).doLatestPostsUntil(function(post){
  ...
  onnewpostbyuser: function (event) {
    ...
    if(this.props.params.username==event.post.getUsername()) {
