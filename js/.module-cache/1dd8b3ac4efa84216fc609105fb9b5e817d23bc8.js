...
module.exports = Home = React.createClass({displayName: "Home",
  ...
  render: function() {
    ...
    var newPostModal = (
      React.createElement(Modal, React.__spread({},  this.props, {handleNewPost: this.handleNewPost, bsStyle: "primary", title: React.createElement(Glyphicon, {glyph: "pencil"})}), 
        React.createElement("div", {className: "modal-body"}, 
          React.createElement("form", {onSubmit: this.props.handleNewPost}, 
