...
var routes = (
  React.createElement(Route, {handler: App, path: "/"}, 
    React.createElement(Route, {name: "accountProfile", path: "/profile", handler: Profile}, 
      ...
      React.createElement(Route, {name: "profile-following", path: "/profile/active-user/following", handler: Following}), 
    ...
    React.createElement(Route, {name: "profile", path: "/profile/:username", handler: Profile}, 
      ...
      React.createElement(Route, {name: "profile-following", path: "/profile/:username/following", handler: Following}), 
