...
App = React.createClass({displayName: "App",
  ...
  switchAccount: function (newaccoutname) {
    ...
    Twister.getAccount(newaccoutname).activateTorrents(function(){
      ...
      localStorage.setItem("twister-react-activeAccount", thisComponent.state.activeAccount);
    });
    ...
    return (
      React.createElement("div", {className: "container"}, 
        React.createElement(ButtonGroup, {justified: true}, 
          React.createElement(Button, {href: "#"}, React.createElement(Glyphicon, {glyph: "home"})), 
          React.createElement(Button, {href: "#/profile"}, React.createElement(Glyphicon, {glyph: "user"})), 
...
var routes = (
  React.createElement(Route, {handler: App, path: "/"}, 
    ...
    React.createElement(Route, {name: "accountProfileMore", path: "/profile/active-user/:subroute", handler: Profile}), 
    React.createElement(Route, {name: "profile", path: "/profile/:username", handler: Profile}), 
    React.createElement(Route, {name: "profileMore", path: "/profile/:username/:subroute", handler: Profile}), 
