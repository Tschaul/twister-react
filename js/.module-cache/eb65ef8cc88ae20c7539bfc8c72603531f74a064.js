...
module.exports = Post = React.createClass({displayName: "Post",
    ...
    render: function() {
        ...
        return (
          ...
          post.isRetwist && 
              React.createElement(Col, {xs: 4}, React.createElement("small", null, React.createElement("span", {className: "glyphicon glyphicon-retweet", "aria-hidden": "true"}), " ", React.createElement("em", null, "  retwisted by ", this.state.retwistingUser))), 
            
          React.createElement(Col, {xs: 4}, React.createElement("small", null, React.createElement("em", {className: "text-right"}, "test")))
            )
