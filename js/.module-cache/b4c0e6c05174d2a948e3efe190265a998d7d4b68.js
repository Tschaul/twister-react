...
App = React.createClass({displayName: "App",
  ...
  switchAccount: function (newaccoutname) {
    ...
    Twister.getAccount(newaccoutname).activateTorrents(function(){
      this.setStateSafe({activeAccount: newaccoutname});
    });
        ...
        React.createElement(Navbar, null, 
          React.createElement(Nav, null, 
            ...
            React.createElement(DropdownButton, {title: "Switch User"}, 
              React.createElement(MenuItem, {onclick: this.switchAccount("tschaul")}, 
                "tschaul"
              ), 
              React.createElement(MenuItem, {onclick: this.switchAccount("timbuktu")}, 
                "timbuktu"
              ), 
              React.createElement(MenuItem, {onclick: this.switchAccount("pampalulu")}, 
                "pampalulu"
              )
            )
          )
