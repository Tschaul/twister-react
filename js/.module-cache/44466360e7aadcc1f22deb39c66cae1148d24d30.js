      ...
      React.createElement("div", {className: "container"}, 
        React.createElement(Grid, null, 
          React.createElement(Row, null, 
            ...
            React.createElement(Col, {xs: 1, className: "fullytight pull-right"}, React.createElement("p", null, this.state.timeAgo))
          ), 
          React.createElement(Row, null, 
            React.createElement(Col, {xs: 6, className: "fullytight"}, 
        post.isRetwist && React.createElement("small", null, React.createElement("span", {className: "glyphicon glyphicon-retweet", "aria-hidden": "true"}), " ", React.createElement("em", null, "  retwisted by ", this.state.retwistingUser))
            ...
            React.createElement(Col, {xs: 6, className: "fullytight"}, React.createElement("p", {className: "pull-right"}, React.createElement("small", null, React.createElement("em", null, "test"))))
          )
        )
      )
