        ...
        React.createElement(Navbar, null, 
          React.createElement(Nav, null, 
            ...
            React.createElement(DropdownButton, {title: "Switch User"}, 
              React.createElement(MenuItem, {onclick: this.switchUser("tschaul")}, 
                "tschaul"
              ), 
              React.createElement(MenuItem, {onclick: this.switchUser("timbuktu")}, 
                "timbuktu"
              ), 
              React.createElement(MenuItem, {onclick: this.switchUser("pampalulu")}, 
                "pampalulu"
              )
            )
          )
