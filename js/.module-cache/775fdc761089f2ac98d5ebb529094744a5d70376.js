...
module.exports = Timeline = React.createClass({displayName: "Timeline",
  ...
  addUser: function(username) {
    ...
    this.setStateSafe(function(previousState, currentProps){
      ...
      thisComponent.updatePosts(2*thisComponent.props.pollInterval);
    });
  ...
  render: function() {
      return (
          React.createElement(Postboard, {data: this.state.data, header: 'Timeline of '+this.props.activeAccount})
        );
  }
});