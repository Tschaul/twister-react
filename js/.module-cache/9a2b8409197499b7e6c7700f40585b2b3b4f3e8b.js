      ...
      React.createElement(ListGroup, {fill: true}, 
        ...
        React.createElement("div", {className: "container fullytight"}, 
          React.createElement(ButtonGroup, {justified: true}, 
            React.createElement(Button, {href: "javascript:void(0);", bsStyle: "active"}, "Timeline"), 
            React.createElement(Button, {href: "javascript:void(0);", href: "javascript:void(0);"}, "Following"), 
            React.createElement(Button, {href: "javascript:void(0);"}, "Mentions"), 
            React.createElement(Button, {href: "javascript:void(0);"}, "Direct Messages")
          )
        ), 
