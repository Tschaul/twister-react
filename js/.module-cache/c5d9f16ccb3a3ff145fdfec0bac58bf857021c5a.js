...
module.exports = Post = React.createClass({displayName: "Post",
    ...
    updateTimeAgo: function() {
      ...
      else if (secondsAgo<30*60) {newTimeAgo=Math.round(secondsAgo/60)+"m"}
      else if (secondsAgo<30*60*60) {newTimeAgo=Math.round(secondsAgo/60/60)+"h"}
      else if (secondsAgo<60*60*60*12) {newTimeAgo=Math.round(secondsAgo/60/60/60)+"d"}
