...
App = React.createClass({displayName: "App",
  ...
  render: function() {
    ...
    var userbuttons = [];
    for (var acc in this.state.accounts) {
      rows.push(React.createElement(MenuItem, {onclick: this.switchAccount(acc.getUsername())}, acc.getUsername()));
    }
      ...
      React.createElement("div", {className: "container"}, 
        React.createElement(Navbar, null, 
          React.createElement(Nav, null, 
            ...
            React.createElement(DropdownButton, {title: "Switch User"}, rows)
          )
        ), 
